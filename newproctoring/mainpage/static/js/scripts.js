...
function enableEdit() {
  document.getElementById('exampleInputFirstName').removeAttribute('readonly');
  document.getElementById('exampleInputLastName').removeAttribute('readonly');
  document.getElementById('exampleInputGroup').removeAttribute('readonly');
